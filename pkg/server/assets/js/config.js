...
class ConfigManager {
    ...
    collectArrConfigs() {
        ...
        this.refs.arrConfigs.querySelectorAll('.arr-config').forEach((arrCard) => {
            ...
            if (!nameInput || !hostInput || !tokenInput || !skipRepairInput || !downloadUncachedInput || !selectedDebridInput || !sourceInput || !markAsFailedSampleInput || !markAsFailedUnableToDetermineInput) {
                return;
            }
